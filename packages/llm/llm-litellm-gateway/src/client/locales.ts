...
export const zh = {
  ...
  plans: '套餐与余额',
  plansHint: '读取 LiteLLM 为各 key / budget 记录的已用与上限；上游 coding plan 若未在网关配置预算，则不会出现在这里。',
...
export const en = {
  ...
  plansHint: 'Reads spend and caps that LiteLLM records per key / budget. An upstream coding plan does not appear here unless its quota is mirrored as a gateway budget.',
